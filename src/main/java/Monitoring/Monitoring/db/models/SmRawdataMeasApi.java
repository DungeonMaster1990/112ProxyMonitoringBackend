...
public class SmRawdataMeasApi {
    ...
    public SmRawdataMeasApi(Integer sessionId, ZonedDateTime timeStamp, Integer measurementId, Float measValue, Integer statusId, String errMsg, Integer rawMonitorId, Integer rawTargetId, Integer rawConnectionId, Integer rawCategoryId, Integer rawThresholdQuality, ZonedDateTime dbdate) {
        SessionId = sessionId;
        TimeStamp = timeStamp;
