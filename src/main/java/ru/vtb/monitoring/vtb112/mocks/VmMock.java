...
public final class VmMock {
    ...
    public static final VmPlanSectionsResponse[] vmPlanSectionsResponse =
            new VmPlanSectionsResponse[]{
                    new VmPlanSectionsResponse("1", "Экстренные", 1),
                    new VmPlanSectionsResponse("2", "Плановые", 5)
            };
    ...
    public static final VmPlanHistoryResponse vmPlanHistoryResponse =
    ...
    public static final VmPlanDescriptionResponse[] vmPlanDescriptionResponse =
    ...
    public static final List<VmAccidentInfoResponse> vmAccidentResponse =
    ...
    public static final VmNewAccidentResponse vmNewAccidentResponse =
            new VmNewAccidentResponse("1", "Авария IM-216836");

    public static final VmAccidentInfoResponse vmAccidentInfoResponse =
            new VmAccidentInfoResponse(
                    "1",
                    "Авария IM-216836",
                    10,
    ...
    public static final VmAccidentWorkersResponse vmAccidentWorkersResponse =
    ...
    public static final VmAccidentHistoryResponse vmAccidentHistoryResponse =
    ...
    public static final List<VmAccidentDescriptionResponse> vmAccidentDescriptionResponse =
            Arrays.asList(
    ...
    public static final VmEventResponse[] vmEventResponse =
            new VmEventResponse[]{
