...
INSERT INTO monitoring.incidents (incident_id, priority, created_at, description, specialist_id)  VALUES ('Инцидент А_6','1', '2020-11-16 19:00:00', 'Проблема', 'Иванов Василий 6');
INSERT INTO monitoring.incidents (incident_id, priority, created_at, description, specialist_id)  VALUES ('Инцидент А_7','2', '2020-11-16 19:00:00', 'Проблема', 'Иванов Василий 7');
INSERT INTO monitoring.incidents (incident_id, priority, created_at, description, specialist_id)  VALUES ('Инцидент А_8','1', '2020-11-16 19:00:00', 'Проблема', 'Иванов Василий 8');
INSERT INTO monitoring.incidents (incident_id, priority, created_at, description, specialist_id)  VALUES ('Инцидент А_9','1', '2020-11-16 19:00:00', 'Проблема', 'Иванов Василий 9');
INSERT INTO monitoring.incidents (incident_id, priority, created_at, description, specialist_id)  VALUES ('Инцидент А_10','3', '2020-11-16 19:00:00', 'Проблема', 'Иванов Василий 10');
INSERT INTO monitoring.incidents (incident_id, priority, created_at, description, specialist_id)  VALUES ('Инцидент А_11','1', '2020-11-16 19:00:00', 'Проблема', 'Иванов Василий 11');
INSERT INTO monitoring.incidents (incident_id, priority, created_at, description, specialist_id)  VALUES ('Инцидент А_12','1', '2020-11-16 19:00:00', 'Проблема', 'Иванов Василий 12');
INSERT INTO monitoring.incidents (incident_id, priority, created_at, description, specialist_id)  VALUES ('Инцидент А_13','2', '2020-11-16 19:00:00', 'Проблема', 'Иванов Василий 13');
INSERT INTO monitoring.incidents (incident_id, priority, created_at, description, specialist_id)  VALUES ('Проблема А_14','1', '2120-11-17 19:00:00', 'Самая свежая проблема', 'Иванов Василий 14');
