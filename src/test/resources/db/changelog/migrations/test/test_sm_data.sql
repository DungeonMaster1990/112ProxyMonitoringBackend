--@formatter:off
INSERT INTO monitoring.incidents (incident_id, priority, created_at, fact_begin_at, description, manager_id, idented_at, assignee_id)
VALUES ('Инцидент А_1', '2', '2020-11-16 12:00:00', '2020-11-16 11:00:00', 'Проблема', 'Иванов Василий 1', '2020-11-16 19:00:00', ''),
       ('Инцидент А_2', '1', '2020-11-16 12:00:00', '2020-11-16 11:00:00', 'Проблема', 'Иванов Василий 2', '2020-11-16 19:00:00', ''),
       ('Инцидент А_3', '1', '2020-11-16 13:00:00', '2020-11-16 12:00:00', 'Проблема', 'Иванов Василий 3', '2020-11-16 19:00:00', ''),
       ('Инцидент А_4', '1', '2020-11-16 14:00:00', '2020-11-16 13:00:00', 'Проблема', 'Иванов Василий 4', '2020-11-16 19:00:00', ''),
       ('Инцидент А_5', '3', '2020-11-16 17:00:00', '2020-11-16 16:00:00', 'Проблема', 'Иванов Василий 5', '2020-11-16 16:00:00', ''),
       ('Инцидент А_6', '1', '2020-11-16 19:00:00', '2020-11-16 17:00:00', 'Проблема', 'Иванов Василий 6', '2020-11-16 19:00:00', ''),
       ('Инцидент А_7', '2', '2020-11-16 19:00:00', '2020-11-16 17:00:00', 'Проблема', 'Иванов Василий 7', '2020-11-16 19:00:00', ''),
       ('Инцидент А_8', '1', '2020-11-16 19:00:00', '2020-11-16 17:00:00', 'Проблема', 'Иванов Василий 8', '2020-11-16 19:00:00', ''),
       ('Инцидент А_9', '1', '2020-11-16 19:00:00', '2020-11-16 17:00:00', 'Проблема', 'Иванов Василий 9', '2020-11-16 19:00:00', ''),
       ('Инцидент А_10', '3', '2020-11-16 19:00:00', '2020-11-16 17:00:00', 'Проблема', 'Иванов Василий 10', '2020-11-16 19:00:00', ''),
       ('Инцидент А_11', '1', '2020-11-16 19:00:00', '2020-11-16 17:00:00', 'Проблема', 'Иванов Василий 11', '2020-11-16 19:00:00', ''),
       ('Инцидент А_12', '1', '2020-11-16 19:00:00', '2020-11-16 17:00:00', 'Проблема', 'Иванов Василий 12', '2020-11-16 19:00:00', ''),
       ('Инцидент А_13', '2', '2020-11-16 19:00:00', '2020-11-16 17:00:00', 'Проблема', 'Иванов Василий 13', '2020-11-16 19:00:00', ''),
       ('Проблема А_14', '1', '2120-11-17 19:00:00', '2120-11-17 17:00:00', 'Самая свежая проблема', '', '2020-11-17 19:00:00', 'Петров Семен');
...
VALUES ('Изменение IM-1', 'На согласовании', 'Согласование', 'Краткое описание1', 'Подробное описание1', 'Описание последствия1', 'Не влияет', '2020-11-16 16:00:00', '2020-11-16 19:00:00', '2020-11-16 16:00:00', '2020-11-16 19:00:00', '', '', 'Платежи,Переводы'),
       ...
       ('Изменение IM-4', 'На согласовании', 'Согласование', 'Краткое описание3', 'Подробное описание3', 'Описание последствия3', 'Не влияет', '2020-11-16 16:00:00', '2020-11-16 19:00:00', '2020-11-16 16:00:00', '2020-11-16 19:00:00', null,               'Петров Иван', 'Платежи,Переводы'),
       ('Изменение IM-5', 'На согласовании', 'Согласование', 'Краткое описание3', 'Подробное описание3', 'Описание последствия3', 'Не влияет', '2020-11-16 16:00:00', '2020-11-16 19:00:00', '2020-11-16 16:00:00', '2020-11-16 19:00:00', 'Иванов Василий', null, 'Платежи,Переводы');
